...
function! unite#sources#versions#svn#file_rec#define()
  return [s:source]
endfunction

function! unite#sources#versions#svn#file_rec#check(type, args)
  try
...
function! s:change_kind(candidate)
  ...
  let candidate.kind = ['versions/svn/status', 'file']
  return candidate
endfunction
